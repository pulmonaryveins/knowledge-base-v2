...
export const appEntries: ReadonlyArray<AppEntry> = [
  ...
  { name: 'ntv360-api', description: 'Core NestJS REST API.', status: 'Live', tags: ['NestJS', 'MySQL'], ownerTeam: 'backend', icon: '⚡', notes: '99.97% uptime SLA.' },
  { name: 'ntv360-graphql', description: 'GraphQL API for flexible queries.', status: 'Dev', tags: ['NestJS', 'GraphQL'], ownerTeam: 'backend', icon: '🔮', notes: 'In active development.' },
  { name: 'ntv360-websocket', description: 'Real-time WebSocket gateway.', status: 'Live', tags: ['NestJS', 'Socket.IO'], ownerTeam: 'backend', icon: '🔌', notes: 'Handles device health events.' },
];
